		...
		<div class="container">
			<div class="row" style="height: 350px;">
				<div class="col-xs-10 col-xs-offset-1">
					...
					<p>Since opening in 2014, we have positively transformed the lives of our residents. We take a comprehensive approach to addiction treatment and sober living that is designed to gradually reintegrate our clients back into the real world.</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 text-center">
				<div style="width: 80%; margin: 0 auto;">
					<img style="margin-bottom: 10px; width: 100%;" src="./images/house-patio.jpg" alt="Riverview Sober House patio">
					<h3>Quality</h3>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 text-center">
				<div style="width: 80%; margin: 0 auto;">
					<img style="margin-bottom: 10px; width: 100%;" src="./images/house-interior.jpg" alt="Riverview Sober House livingroom"> 
					<h3>Sober</h3>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 text-center">
				<div style="width: 80%; margin: 0 auto;">
					<img style="margin-bottom: 10px; width: 100%;" src="./images/house-exterior.jpg" alt="Riverview Sober House housing"> 
					<h3>Housing</h3>
